package mk.ukim.finki.elibrary.server.web.controllers.filters;
...
import mk.ukim.finki.elibrary.server.constants.JwtConstants;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public JwtFilter(JwtHelper jwtHelper, EmployeeService employeeService, HandlerExceptionResolver handlerExceptionResolver) {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (jwtHelper.isValid(token, employee.get())) {
